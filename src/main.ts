...
import { camera, cameraOutline, chevronForward, heart, heartCircle, home, lockClosed, logOutOutline, mail, person, personCircle, personCircleOutline } from 'ionicons/icons';
